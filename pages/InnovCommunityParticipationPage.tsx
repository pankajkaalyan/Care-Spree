                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    <div className="lg:col-span-2">
                        <div className="rounded-lg shadow-lg w-full mb-8 image-hover-effect">
                          <img src="images/services/innovative-community-participation.jpeg" alt="People participating in a creative community activity" className="w-full object-cover" />
                        </div>
