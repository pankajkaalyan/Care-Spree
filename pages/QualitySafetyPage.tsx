        ...
        <>
            ...
            <section className="py-16 sm:py-24 bg-white dark:bg-gray-900">
                <div className="container mx-auto px-6 space-y-24">
                    <SectionCard imageUrl="./images/quality-safety-commitment.svg" title="Our Commitment to Excellence">
                    ...
                    <SectionCard imageUrl="./images/quality-safety-standards.svg" title="NDIS Practice Standards & Compliance" reverse={true}>
                     ...
                     <SectionCard imageUrl="./images/quality-safety-feedback.svg" title="Your Feedback Matters">
